...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    WebViewController *web = [[WebViewController alloc]initWithWebURL:@"https://jtapp.jtarw.com/login" andType:1];
...
//    if ([Utils isFirstRun]) {
//
//        self.window.rootViewController = [[MengLeadView alloc] init];
//    }
//    else {
//
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"FitnessEducation"];
